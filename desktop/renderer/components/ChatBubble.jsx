...
const markdownComponents = {
  ...
  h3({ children }) {
    return <h3 className="text-sm font-semibold text-white mb-1.5 mt-2">{children}</h3>;
  },
  blockquote({ children }) {
    return (
  ...
  hr() {
    return <hr className="border-gray-600 my-3" />;
  },
  a({ href, children }) {
    return (
...
// Simple inline renderer for user messages (no markdown needed)
